      ...
      <div class="col-8" id="ask-form">
        <form id="login-form" method="GET">
                  ...
                  <label for="inputTitle">ចំណងជើង - Title</label>
                    <input type="text" id="inputtitle" class="form-control" placeholder="ចំណងជើង - Type something here...." required="" autofocus="">
                  <label for="inputText">បន្ថែមលំអិត - More Detail</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
                  <div class="col-4 my-2">
                    <button class="btn btn-lg btn-danger" type="submit">Post Your Answer</button>
                  </div>
        </form>
      </div>  
      <div class="col">
